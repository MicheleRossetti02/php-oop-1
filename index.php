...
class Movie
{
    ...
    public function __construct(string $title,  string $link, array $genere)
    {
        $this->title = $title;
        $this->link = $link;
        $this->genere = $genere;
...
$spiderman = new Movie("The Amazing Spiderman The Power Of Electro", "www.TheAmazingSpidermanThePowerOfElectro.com", $generes);
$spiderman->setDiscount(9);
$discountspiderman = $spiderman->getDiscount();

$matrix = new Movie("Matrix",  "www.matrix.com", $generes);
